...
export const UNISWAP_V3_ROUTER: { [key: Chain['id']]: Address } = {
  [foundry.id]: zeroAddress,
  [base.id]: /** @dev SwapRouter02 */ '0x2626664c2603336E57B271c5C0b26F421741e481',
  [mainnet.id]: /** @dev SwapRouter02 */ '0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45',
}
export const USDC_BASE: `0x${string}` = '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913'
export const WETH: { [key: Chain['id']]: Address } = {
  [foundry.id]: zeroAddress,
...
/** @dev QuoterV2 via Uniswap V3 */
export const UNISWAP_V3_QUOTER: { [key: Chain['id']]: Address } = {
  [foundry.id]: zeroAddress,
